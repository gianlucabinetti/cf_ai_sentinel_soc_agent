...
OUTPUT:
{"attackType":"SQLi","confidence":"High","riskScore":95,"explanation":"Boolean-based SQL injection using tautology '1=1'. UNION and OR operators detected.","impact":"Unauthorized database access and potential data exfiltration.","mitigation":"Use parameterized queries and input validation.","action":"block"}

INPUT: "<script>alert('xss')</script>"
OUTPUT:
{"attackType":"XSS","confidence":"High","riskScore":90,"explanation":"Inline JavaScript execution via script tag. Classic reflected XSS pattern.","impact":"Session hijacking and credential theft.","mitigation":"Sanitize HTML output and implement Content Security Policy.","action":"block"}

INPUT: "hello world"
OUTPUT:
{"attackType":"Benign","confidence":"High","riskScore":0,"explanation":"No malicious patterns detected. Standard alphanumeric string.","impact":"None.","mitigation":"None required.","action":"allow"}
